...
const ReservationForm = () => {
	...
	return (
		<div className="h-dvh bg-black 	p-52">
			<div className="container mx-auto max-w-[600px] bg-blue-200 rounded-lg p-8">
				...
				<form onSubmit={formik.handleSubmit} className="space-y-4">
					...
					<button type="submit" className="bg-blue-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-600 focus:outline-none focus:bg-blue-600">
						Submit Reservation
					</button>
				</form>
			</div>{" "}
