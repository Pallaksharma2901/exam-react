...
const Navbar = () => {
	return (
		<>
			<header className="bg-[beighe] text-white body-font">
				<div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
					<Link to="/" className="flex title-font font-medium items-center text-black mb-4 md:mb-0">
						<span className="ml-3 text-xl">Hotel Management</span>
					</Link>
					<nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-lg tracking-wide justify-center">
						<Link to="/" className="mr-5  text-black">
							Home
						</Link>
						<Link to="/roomlist" className="mr-5  text-black">
							RoomList
						</Link>
						<Link to="/reservationlist" className="mr-5  text-black">
							ReservationList
						</Link>
						<Link to="/userprofile" className="mr-5  text-black">
							User profile
						</Link>
					</nav>
