				...
				<table className="table-auto w-full border shadow rounded-lg">
					<thead>
						<tr className="bg-black text-left">
							...
							<th className="px-4 py-2 text-white">Person Count</th>
							<th className="px-4 py-2 text-white">Check-in Date</th>
							<th className="px-4 py-2 text-white">Check-out Date</th>
